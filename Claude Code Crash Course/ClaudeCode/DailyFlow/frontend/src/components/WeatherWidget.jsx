...
export default function WeatherWidget() {
  ...
  return (
    <div className="relative w-72 h-40 rounded-2xl overflow-hidden bg-gradient-to-br from-indigo-600 to-indigo-900 text-white shadow-lg fade-slide-up" style={{ animationDelay: '0.24s' }}>
      {/* Background SVG */}
      <svg
        fill="none"
        viewBox="0 0 342 175"
      ...
      >
        ...
        />
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="weatherGradient">
      ...
      <div className="absolute right-0 top-0 w-32 h-32 -mr-4">
        <svg fill="#75d6ff" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" className="w-full h-full opacity-80">
          <g>
      ...
      <div className="relative z-10 flex flex-col justify-between h-full p-5">
        ...
        <div className="flex justify-between items-start">
          <div>
            <p className="text-sm opacity-75">H:{weather.high}° L: {weather.low}°</p>
